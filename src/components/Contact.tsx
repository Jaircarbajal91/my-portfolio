    ...
    <section id="contact" ref={ref} className="section-padding">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-3 font-medium">
            Let's build something great together — drop me a line.
          </p>
          <p className="text-base text-gray-600 dark:text-gray-400 max-w-3xl mx-auto italic">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-8 md:mb-12">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  href={info.href}
                  className="flex flex-col items-center p-6 card hover:scale-105 hover:-translate-y-1 hover:shadow-xl hover:border-primary-600/30 dark:hover:border-primary-400/30 border border-transparent transition-all duration-300 text-center"
                >
